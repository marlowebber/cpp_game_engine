...
void growIntoNeighbours(unsigned int worldI, unsigned int material)
{
	...
	// 				game.world[neighbour].growthMatrix[i] = true; // then after branching, the limb just grows straight, initially at least.
	// 			}
	// 		}
	// 	}
